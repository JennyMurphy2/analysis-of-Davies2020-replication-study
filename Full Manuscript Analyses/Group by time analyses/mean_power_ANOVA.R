...
mean_data_45 <- rep_data %>%
  ...
  select(id, group, pre_mp_rep_1:post_mp_rep_2) # only interested in mean power right now
...
mean_data_45 <- mean_data_45 %>% 
  rowwise() %>%
  mutate(pre = max(pre_mp_rep_1, pre_mp_rep_2, na.rm = TRUE),
         post = max(post_mp_rep_1, post_mp_rep_2, na.rm = TRUE)) %>%
  as.data.frame()
...
ggplot(anova_mean_45, aes(sample = mean_power)) +
  geom_qq() +
  geom_qq_line() +
...
ggplot(anova_mean_45, aes(x = time, y = mean_power)) +
...
ggplot(anova_mean_55, aes(sample = mean_power)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_mean_55, aes(x = time, y = mean_power)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)
...
ggplot(anova_mean_65, aes(sample = mean_power)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_mean_65, aes(x = time, y = mean_power)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)
...
ggplot(anova_mean_75, aes(sample = mean_power)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_mean_75, aes(x = time, y = mean_power)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)
...
ggplot(anova_mean_85, aes(sample = mean_power)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_mean_85, aes(x = time, y = mean_power)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)
