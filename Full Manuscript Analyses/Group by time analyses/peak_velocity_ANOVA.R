...
peak_data_45 <- rep_data %>%
  ...
  select(id, group, pre_pv_rep_1:post_pv_rep_2) # only interested in peak velocity right now
...
peak_data_45 <- peak_data_45 %>% 
  rowwise() %>%
  mutate(pre = max(pre_pv_rep_1, pre_pv_rep_2, na.rm = TRUE),
         post = max(post_pv_rep_1, post_pv_rep_2, na.rm = TRUE)) %>%
  as.data.frame()
...
hist_45_plot <- ggplot(data = hist_45, aes(x = value, fill = variable)) +
  geom_histogram(color = "black", fill = "white",
                 bins = 15) +
  facet_wrap( ~ variable) +
  scale_x_continuous(name = "Peak velocity")
hist_45_plot

### Q-Q plots 

ggplot(anova_peak_45, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
...
ggplot(anova_peak_45, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 45% Peak velocity ANOVA -----------------------------------------

##afex::aov_4(continuous_var ~ group_var + (RM_var|id_var)

anova_45_afx <- afex::aov_4(
  peak_velocity ~ group * time + (time | id),
  data = anova_peak_45,
...
anova_peak_45 %>% 
  dplyr::group_by(time) %>% 
  rstatix::shapiro_test(peak_velocity)
...
anova_peak_45 %>%
  group_by(time) %>%
  rstatix::identify_outliers(peak_velocity)
...
ggplot(anova_peak_55, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_peak_55, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 55% Peak velocity ANOVA -----------------------------------------
...
ggplot(anova_peak_65, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_peak_65, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 65% Peak velocity ANOVA -----------------------------------------
...
ggplot(anova_peak_75, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_peak_75, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 75% Peak velocity ANOVA -----------------------------------------
...
ggplot(anova_peak_85, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_peak_85, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 85% Peak velocity ANOVA -----------------------------------------
...
ggplot(anova_peak_95, aes(sample = peak_velocity)) +
  geom_qq() +
  geom_qq_line() +
  scale_x_continuous(name = "Observed Value") +
  scale_y_continuous(name = "Expected Normal")
...
ggplot(anova_peak_95, aes(x = time, y = peak_velocity)) +
  geom_violin(trim = FALSE) +
  geom_boxplot(width = .2)

## 95% Peak velocity ANOVA -----------------------------------------
